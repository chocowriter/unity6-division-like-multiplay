namespace SheetXExample
{
	...
	public static class LocalizationExample1
	{
		public enum ID 
		{
			NONE = -1,
			message_1 = 0, message_2, message_3, message_4, message_5, content_1, content_2, content_3, content_4, content_5, title_1, title_2, title_3, title_4, title_5, title_6, whatever_msg, hero_name_1, hero_name_2, hero_name_3, hero_name_4, hero_name_5, language, language_en, language_es, language_jp, language_ko, language_th, language_cn,
		}
		public const int
			message_1 = 0, message_2 = 1, message_3 = 2, message_4 = 3, message_5 = 4, content_1 = 5, content_2 = 6, content_3 = 7, content_4 = 8, content_5 = 9, title_1 = 10, title_2 = 11, title_3 = 12, title_4 = 13, title_5 = 14, title_6 = 15, whatever_msg = 16, hero_name_1 = 17, hero_name_2 = 18, hero_name_3 = 19, hero_name_4 = 20, hero_name_5 = 21, language = 22, language_en = 23, language_es = 24, language_jp = 25, language_ko = 26, language_th = 27, language_cn = 28;
		public static readonly string[] idString = new string[]
		{
			"message 1", "message 2", "message 3", "message 4", "message 5", "content_1", "content_2", "content_3", "content_4", "content_5", "title 1", "title 2", "title 3", "title 4", "title 5", "title 6", "whatever_msg", "hero_name_1", "hero_name_2", "hero_name_3", "hero_name_4", "hero_name_5", "language", "language_en", "language_es", "language_jp", "language_ko", "language_th", "language_cn",
		};
		public static readonly Dictionary<string, string> LanguageFiles = new Dictionary<string, string>() {  { "en", "LocalizationExample1_en" }, { "es", "LocalizationExample1_es" }, { "jp", "LocalizationExample1_jp" }, { "ko", "LocalizationExample1_ko" }, { "th", "LocalizationExample1_th" }, { "cn", "LocalizationExample1_cn" }, };
	    ...
	    public static async void Init()
		{
			...
			{
	#if UNITY_EDITOR
				Debug.Log($"Init {nameof(LocalizationExample1)}");
	#endif
	    ...
	    /// <summary>
	    /// Used this if you are unable to add LocalizationExample1Text component to the gameObject
	    /// </summary>
	...
	#if UNITY_EDITOR
	        if (pObj.TryGetComponent(out LocalizationExample1Text _))
	            Debug.LogError($"{pObj.name} should not have LocalizationExample1Text!");
	#endif
	    }
		...
		private static void CreateClassContainsRefinedIds(string pPath)
		{
			...
			Debug.Log($"{ids.Count} ids of LocalizationExample1 has been used, The info at path {pPath}");
		...
		{
			var components = obj.GetComponentsInChildren<LocalizationExample1Text>(true);
		...
		private static void CreateClassContainsRefinedIds(List<string> pRefinedIds)
		{
			...
			{
				enumIds += $"{nameof(LocalizationExample1)}.ID.{pRefinedIds[i]}";
				intIds += $"{nameof(LocalizationExample1)}.{pRefinedIds[i]}";
			...
			var path = $"{directoryPath}/{nameof(LocalizationExample1)}RefinedIds.cs";
			System.IO.File.WriteAllText(path, result);
			Debug.Log($"Created {path}");
		}
		private static string GetTemplateClassContainsRefinedIds()
		{
			string @namespace = typeof(LocalizationExample1).Namespace + "abc";
			string className = "LocalizationExample1RefinedIds";
			string enumField = "public static readonly List<LocalizationExample1.ID> enumIds = new List<LocalizationExample1.ID> { ENUM_IDS };";
			...
			string content = $"using System.Collections.Generic;{Environment.NewLine}"
				+ "// This script refines the IDs of LocalizationExample1 used in any prefab within the project. It searches all prefabs containing the LocalizationExample1 component and retrieves the localized ids."
		...
		[MenuItem("Assets/Create/LocalizationX/Refine LocalizationExample1 Ids")]
